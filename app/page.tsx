...
type Testimonial = { id: string; quote: string; name: string; company?: string };
...
const SERVICES: Service[] = [
  {
    ...
    icon: (
      <svg className="w-8 h-8 text-[#FF6B35]" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M7 14v5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8 text-[#FF6B35]" viewBox="0 0 24 24" fill="none">
        <path d="M4 7h16v10H4z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
...
const PROJECTS: Project[] = [
  { id: "p1", title: "City Center Billboard", location: "MG Road", img: "/images/hoarding-1.jpg" },
  { id: "p2", title: "Mall Entrance Wrap", location: "Central Mall", img: "/images/hoarding-2.jpg" },
  { id: "p3", title: "LED Roadside", location: "Ring Road", img: "/images/hoarding-3.jpg" },
  { id: "p4", title: "Transit Shelter", location: "Bus Stand", img: "/images/hoarding-4.jpg" },
];

const TESTIMONIALS: Testimonial[] = [
  { id: "t1", quote: "Great locations and timely service. Our footfall doubled!", name: "Asha Patel", company: "Cafe Aroma" },
  { id: "t2", quote: "Professional team and excellent print quality.", name: "Ravi Kumar", company: "Kumar Textiles" },
];
    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section id="services" className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-slate-600 mb-6 max-w-2xl">
          End-to-end outdoor advertising services — from site survey and creative to installation and maintenance.
        </p>
      ...
      <section id="portfolio" className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-slate-600">A selection of recent hoardings, wraps and LED installations.</p>
          </div>
          <Link href="/featured" className="text-sm underline">View all</Link>
        </div>
      ...
      <section className="bg-orange-50 py-12">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h3 className="text-xl font-semibold">Ready to launch your campaign?</h3>
            <p className="mt-2 text-slate-700">Tell us your goals and we'll propose prime locations and creative options.</p>
          </div>
          <div className="flex gap-3 flex-wrap">
            <Link href="/contact" className="inline-flex items-center gap-2 bg-[#f07e04] px-4 py-3 rounded-md font-semibold transition-all duration-500 hover:bg-[#ff8c42] hover:scale-105 hover:shadow-lg">
              Contact Us
            </Link>
            <a href="tel:+919373734774" className="inline-flex items-center gap-2 px-4 py-3 rounded-md border border-slate-800 transition-all duration-300 hover:bg-transparent hover:text-black hover:border-black">
              Call Us
            </a>
          </div>
        </div>
      ...
      <footer className="bg-white border-t py-8">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-md bg-[#f07e04] flex items-center justify-center font-bold text-white">AD</div>
            <div>
              <div className="font-semibold">LocalAds Co.</div>
              <div className="text-sm text-slate-600">Making brands visible since 2015</div>
            </div>
          </div>
          ...
          <div className="text-sm text-slate-700">
            ...
            <div className="mt-2 text-slate-500 text-xs">Registered office • City Name</div>
          </div>
        </div>
